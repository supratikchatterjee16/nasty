...
text = "Sanjeev Siva has such a wonderful brother named Lord Siva. He owns the fantastical country of Jeginsport. A company named Shitarus is owned by him."
mod_text = sentence_util.cleanse_pos_tags(text, "PDT","DT", "JJ", "JJR")
print(mod_text)
print()
print(sentence_util.get_tagged_tokens(text))
print()
print(sentence_util.get_tagged_tokens(mod_text))
